...
import rcp.example.workbench.actions.PrestashopAction;
...
public class Application implements IApplication {
	 ...
	 *
	 */
	public static final boolean CREATE_WORKBENCH=false;
		...
		try{
			...
			if (LicenceManager.instance.load(
				...
				EmpresasXml.instance.create("H2 Integrado",
					ConnectionManager.DRIVER_H2, "", database, "sa", ""), // 2
				/*
				 * UTILIZADOR
